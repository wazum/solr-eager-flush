...
final class ItemTypeMatcherTest extends TestCase
{
    ...
    public function testBothMatchesEverything(): void
    {
    ...
    public function testPagesMatchesOnlyPages(): void
    {
    ...
    public function testRecordsMatchesEverythingExceptPages(): void
    {
